...
def get_path(case):
    ...
    if case == "full_playground_inch":
        return [Point(3, 0, 0, "top", None), Point(1, 0, 0, "top", None), Point(4, 0, 0, "top", None),
                Point(2, 0, 0, "top", None), Point(5, 0,
                                                   0,
                                                   "top", None), Point(3, 0, 0, "top", None)]
    if case == "stairs":
        return [Point(3, 0, 1, "top", None), Point(2, 0, 0, "top", None), Point(4, 0, 2, "top", None),
                Point(3, 0, 1, "top", None), Point(5, 0, 3, "top", None), Point(4, 0, 2,
                                                                                "top", None)]
    else:
        return [Point(3, 0, 0, 'top', None)]
