...
class SerialLink:
    ...
    def ikineConstrained(self, direction, p, theta=-pi / 2, phi=0, accuracy=1e-7, num_iterations=1000, alpha=0.1,
                         prior_q=None, vertical=False, flipped=False):
    ...
    def _display_path(self,
                      path=[(0, 0, 0, "top"), (1, 0, 0, "top"), (2, 0, 0, "top"), (3, 0, 0, "top"), (4, 0, 0, "top"),
                            (5, 0, 0, "top"), ]):
        for point in path:
