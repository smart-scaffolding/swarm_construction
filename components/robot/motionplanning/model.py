...
from components.robot.motionplanning.serial_link import SerialLink, Revolute
...
class Inchworm(SerialLink):
    def __init__(
        ...
        super().__init__(
            links=links,
            a_link_starting_pos=a_link_starting_pos,
            d_link_starting_pos=d_link_starting_pos,
            name="inchworm",
            stl_files=None,
            colors=None,
            param=param,
