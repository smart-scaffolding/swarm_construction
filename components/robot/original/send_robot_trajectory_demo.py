...
path = [
    ...
    Point(5, 2, 2, "top", None),
    Point(6, 3, 3, "top", None),
    Point(7, 4, 4, "top", None),
    Point(8, 6, 5, "top", None),
    Point(10, 8, 6, "top", None),
    Point(11, 9, 8, "top", None),
    Point(10, 9, 7, "top", None),
    Point(10, 8, 7, "top", block_id),
    Point(9, 8, 6, "top", None),
