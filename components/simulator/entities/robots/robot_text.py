...
from components.simulator.globals import guiManager


class RobotText:
    """
    Used to display name and debug information for robots. Toggling of debug text is controlled by GUI manager
