def ctraj(T0, T1, N):
    ...
    def one_to_one(T0, T1):
        ...
        for i in time_steps:
            ...
            transl_interped = transl(
                [transl_interped[0, 0], transl_interped[1, 0], transl_interped[2, 0]]
            )
    ...
    if ishomog(T0, (4, 4)):
        ...
        if ishomog(T1, (4, 4)):
            ...
            assert len(T0) == len(
                T1
            ), "For many to many trajectory computation, both lists should be of same length"
