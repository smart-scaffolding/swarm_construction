...
import py_trees
import sys
from .motion_planning_behaviors import get_motion_planning_behaviors_tree, get_move_to_point_tree
import py_trees.console as console
from robot.common.states import Block, MoveBlocksStore, Division, RobotBehaviors
from robot.communication.messages import StatusUpdateMessage
import time
import uuid
##############################################################################
# Classes
...
def create_move_robot_root(robot_communicator, simulator_communicator):
    ...
    move_to_point_behavior = get_move_to_point_tree(robot_communicator=robot_communicator, simulator_communicator=simulator_communicator)
