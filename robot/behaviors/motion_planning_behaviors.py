...
def get_path_to_point(robot, destination, simulator_communicator):
    """
    ...
    print("Path found")
    if Config.SIMULATE:
        simulator_communicator.robot_communicator.send_communication("Got path")
    return [(1, 0, 0, "Top"), (2, 0, 0, "Top"), (3, 0, 0, "Top"), (4, 0, 0, "Top")]
...
class NavigateToPoint(py_trees.behaviour.Behaviour):
    ...
    def initialise(self):
        ...
        self.path = get_path_to_point(self.robot, self.point_to_reach, self.robot_communicator)
...
def create_root(robot_communicator, simulator_communicator, set_variables=False):
    """
    ...
    task_one = NavigateToPoint(name="MoveToBlockToRemove", key="point_to_reach", robot="MyRobot",
                               robot_communicator=robot_communicator, simulator_communicator=simulator_communicator)
    task_two = RemoveBlock(name="RemoveBlock", key="block_to_remove", robot="MyRobot",
                           robot_communicator=robot_communicator, simulator_communicator=simulator_communicator)
    task_three = NavigateToPoint(name="MoveToPlaceBlock", key="point_to_reach_2", robot="MyRobot",
                                 robot_communicator=robot_communicator, simulator_communicator=simulator_communicator)
    task_four = PlaceBlock(name="PlaceBlock", key="location_to_place_block", robot="MyRobot",
                           robot_communicator=robot_communicator, simulator_communicator=simulator_communicator)
...
def main():
    ...
    root = create_root(set_variables=True)
...
def get_motion_planning_behaviors_tree(robot_communicator, simulator_communicator):
    """
...
def get_move_to_point_tree(robot_communicator, simulator_communicator):
    """
